...
namespace Corely.Core.Text
{
    public static class Normalization
    {
        ...
        private static List<Tuple<string, string, bool>> _commonStreetAbbreviations = new List<Tuple<string, string, bool>>
        {
            // Ordinal 
        ...
        private static List<Tuple<string, string>> _commonStateAbbreviations = new List<Tuple<string, string>>()
        { 
            // States

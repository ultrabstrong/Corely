...
public class PermissionValidatorTests
{
    ...
    public void PermissionValidator_HasValidationError_WhenPermissionNameInvalid(string permissionName)
    {
    ...
    public void PermissionValidator_HasValidationError_WhenPermissionNameLengthInvalid(string permissionName)
    {
        var permission = new Permission
        {
            Name = permissionName
